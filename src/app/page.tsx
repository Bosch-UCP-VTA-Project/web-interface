...
//     <ScrollArea
//       className="flex-grow mb-4 p-4 rounded-lg bg-gray-800/50 backdrop-blur-sm border border-gray-700"
//       ref={scrollAreaRef}
//     >
...
//               } hover:from-purple-600 hover:to-purple-700 text-white relative z-20`}
//             >
...
//     setInput("");
//     setIsLoading(true);
//     setLoadingMessage("The agent is thinking..."); // Add this line
...
//     } finally {
//       setIsLoading(false);
//       setLoadingMessage(""); // Add this line
//     }
//   };
...
//   return (
//     <div className="flex h-screen bg-[#F2F2F2] text-[#333333]">
//       <aside className="w-64 bg-[#333333] text-white p-4">
//         <Button
//           variant="outline"
...
//                 <h2 className="text-lg font-semibold mb-2">How to use:</h2>
//                 <ul className="list-disc pl-5 space-y-2">
//                   <li>Ask questions about Bosch products and services</li>
...
//   const renderSidebar = () => (
//     <aside
//       className={`w-64 bg-[#333333] text-white p-4 ${
